...
- **2026-08-05（PWA App 壳层第二轮改造，本地待上线）**:
  ...
  - 缓存版本：`css/pwa.css` / `js/pwa.js` → `?v=20260805-appshell2`；`sw.js` → `VERSION = 20260805-v5`。上线后需确认已安装设备出现更新提示，并验证中心任务启动层、次级页返回、离线徽标和旧缓存清理。
