...
const DEFAULT_PATHS = [
    { id:'path1', slug:"starter", title:"AI 入门基础", subtitle:"零基础快速上手AI工具", icon:"ph-rocket-launch",
      gradient:"linear-gradient(135deg,#f1ede1 0%,#e4ddc8 100%)", duration:"约 2 周", level:"入门",
    ...
    { id:'path2', slug:"teacher", title:"AI 教学应用", subtitle:"将AI工具融入日常教学全流程", icon:"ph-chalkboard-teacher",
      gradient:"linear-gradient(135deg,#ece6d3 0%,#dccdb1 100%)", duration:"约 4 周", level:"进阶",
    ...
    { id:'path3', slug:"creator", title:"AI 创作进阶", subtitle:"用AI打造沉浸式教学体验", icon:"ph-sparkle",
      gradient:"linear-gradient(135deg,#f6e5dd 0%,#ecc8b7 100%)", duration:"约 6 周", level:"高级",
